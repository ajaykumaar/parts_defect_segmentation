...
# load weights
model.load_state_dict(torch.load("./model_chkpts/unetpp_v2.pth"))
...
# ----------------- Run Evaluations -----------------
# if agrs.synthetic:
eval_with_val_ds(model, val_imgs, val_masks, image_transform, resize_shape, num_samples=10)
eval_with_synthetic_data(model, "./data/bracket_white/synthetic_data", image_transform, resize_shape)